...
const CharacterList = () => {
  ...
  return (
    <div className={styles.container}>
      <h1 className={styles.title}>Personagens do filme Harry Potter</h1>
        ...
        {characters.map((character) => (
          <div key={character.id} className={styles.characterCard}>
            ...
            <div className={styles.content}>
              ...
              <p className={styles.dateOfBirth}>Data de aniversário: {character.dateOfBirth}</p>
              <p className={styles.species}>Espécie: {character.species}</p>
              <p className={styles.house}>Casa: {character.house}</p>
